    ...
    return (
        <div className="py-5">
            <div className="container text-center team-container py-5">
                <h1 className="header-color">Subscribe Our Newsletter</h1>
                <img src={service} alt="" />
                <p className="py-3 font">Enter Your email address to join our mailing list and keep yourself update</p>
